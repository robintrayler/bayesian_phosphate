...
# source('./R/09_otodus_ungrouped_modeling.R')
# source('./R/10_carcharias_ungrouped_modeling.R')
# source('./R/11_meso_ungrouped_modeling.R')

ecto <- read_csv(file = './data/ecto_posterior.csv') %>% 
  mutate(thermo = 'ecto')
meso <- read_csv(file = './data/meso_posterior.csv') %>% 
  mutate(thermo = 'meso')
meso_ungrouped <- read_csv(file = './data/meso_ungrouped_posterior.csv') %>% 
  mutate(thermo = 'meso_ungrouped')
...
white_ungrouped <- read_csv(file = './data/carcharias_ungrouped_posterior.csv') %>% 
  mutate(thermo = 'white_shark_ungrouped')
...
otodus_ungrouped <- read_csv(file = './data/otodus_ungrouped_posterior.csv') %>% 
  mutate(thermo = 'otodus_ungrouped')
burn <- 5000
